...
image = Image.open('flaresGraph1.png')
with open("flaresGraph1.png", "rb") as file:
...
image = Image.open('flaresGraph2.png')
with open("flaresGraph2.png", "rb") as file:
    btn=st.download_button(label="Download graph", data=file, file_name='/flaresGraph2.png',mime="image/png")


# def plot_raw_data():
#     fig2 = go.Figure()
#     fig2.add_trace(go.Scatter(x=time['start_datetime'], y=time['peak.c/s'], name ='LSTM'))
#     fig2.add_trace(go.Scatter(x=time['time_valid'], y=time['rnn_forecast'], name ='GRU'))
#     fig2.layout.update(title_text="Solar Flares data")
